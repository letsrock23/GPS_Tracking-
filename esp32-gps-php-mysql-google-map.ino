...
//enter your domain name and path
//like this http://www.example.com/gpsdata.php
...
long interval = 30000; //can be change interval time by changing this value 
...
int sendGpsToServer()
{
  ...
  if(true){
    ...
    //if want to show date, time and speed then active this lines 
